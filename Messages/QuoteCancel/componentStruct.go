...
type QuoteCancel struct {
    ...
    QuoteCancelType Types.Int `id:"298", required:"Y" `
    ...
    QuoteEntries []QuotCxlEntriesGrp_QuoteEntries.QuotCxlEntriesGrp_QuoteEntries `counter_name:"NoQuoteEntries", counter_id:"295"`
