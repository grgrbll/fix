...
func (m *SecurityStatus) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.SecurityStatusReqID.HasValue() {
        (*res).WriteString("324=")
        val, err := m.SecurityStatusReqID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SecurityTradingStatus.HasValue() {
        (*res).WriteString("326=")
        val, err := m.SecurityTradingStatus.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.HaltReason.HasValue() {
        (*res).WriteString("327=")
        val, err := m.HaltReason.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.InViewOfCommon.HasValue() {
        (*res).WriteString("328=")
        val, err := m.InViewOfCommon.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.DueToRelated.HasValue() {
        (*res).WriteString("329=")
        val, err := m.DueToRelated.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.BuyVolume.HasValue() {
        (*res).WriteString("330=")
        val, err := m.BuyVolume.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SellVolume.HasValue() {
        (*res).WriteString("331=")
        val, err := m.SellVolume.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.Adjustment.HasValue() {
        (*res).WriteString("334=")
        val, err := m.Adjustment.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.FirstPx.HasValue() {
        (*res).WriteString("1025=")
        val, err := m.FirstPx.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *SecurityStatus) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message SecurityStatus (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *SecurityStatus) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 324:
            if !m.SecurityStatusReqID.HasValue() {
                used = true
                err = m.SecurityStatusReqID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 326:
            if !m.SecurityTradingStatus.HasValue() {
                used = true
                err = m.SecurityTradingStatus.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 327:
            if !m.HaltReason.HasValue() {
                used = true
                err = m.HaltReason.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 328:
            if !m.InViewOfCommon.HasValue() {
                used = true
                err = m.InViewOfCommon.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 329:
            if !m.DueToRelated.HasValue() {
                used = true
                err = m.DueToRelated.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 330:
            if !m.BuyVolume.HasValue() {
                used = true
                err = m.BuyVolume.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 331:
            if !m.SellVolume.HasValue() {
                used = true
                err = m.SellVolume.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 334:
            if !m.Adjustment.HasValue() {
                used = true
                err = m.Adjustment.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1025:
            if !m.FirstPx.HasValue() {
                used = true
                err = m.FirstPx.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
