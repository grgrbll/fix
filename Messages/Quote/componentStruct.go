...
type Quote struct {
    ...
    QuoteResponseLevel Types.Int `id:"301", required:"N" `
    ...
    Legs []LegQuotGrp_Legs.LegQuotGrp_Legs `counter_name:"NoLegs", counter_id:"555"`
    ...
    BidSwapPoints Types.PriceOffset `id:"1065", required:"N" `
    OfferSwapPoints Types.PriceOffset `id:"1066", required:"N" `
