...
type MassQuote struct {
    ...
    DefBidSize Types.Qty `id:"293", required:"N" `
    DefOfferSize Types.Qty `id:"294", required:"N" `
    QuoteSets []QuotSetGrp_QuoteSets.QuotSetGrp_QuoteSets `counter_name:"NoQuoteSets", counter_id:"296"`
