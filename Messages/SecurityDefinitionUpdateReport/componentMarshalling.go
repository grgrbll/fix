...
func (m *SecurityDefinitionUpdateReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.SecurityReportID.HasValue() {
        (*res).WriteString("964=")
        val, err := m.SecurityReportID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SecurityResponseType.HasValue() {
        (*res).WriteString("323=")
        val, err := m.SecurityResponseType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SecurityUpdateAction.HasValue() {
        (*res).WriteString("980=")
        val, err := m.SecurityUpdateAction.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ExpirationCycle.HasValue() {
        (*res).WriteString("827=")
        val, err := m.ExpirationCycle.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.RoundLot.HasValue() {
        (*res).WriteString("561=")
        val, err := m.RoundLot.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.MinTradeVol.HasValue() {
        (*res).WriteString("562=")
        val, err := m.MinTradeVol.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *SecurityDefinitionUpdateReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message SecurityDefinitionUpdateReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *SecurityDefinitionUpdateReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 964:
            if !m.SecurityReportID.HasValue() {
                used = true
                err = m.SecurityReportID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 323:
            if !m.SecurityResponseType.HasValue() {
                used = true
                err = m.SecurityResponseType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 980:
            if !m.SecurityUpdateAction.HasValue() {
                used = true
                err = m.SecurityUpdateAction.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 827:
            if !m.ExpirationCycle.HasValue() {
                used = true
                err = m.ExpirationCycle.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 561:
            if !m.RoundLot.HasValue() {
                used = true
                err = m.RoundLot.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 562:
            if !m.MinTradeVol.HasValue() {
                used = true
                err = m.MinTradeVol.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
