...
type TradeCaptureReportRequest struct {
    ...
    Underlyings []TradeCaptureReportRequest_Underlyings.TradeCaptureReportRequest_Underlyings `counter_name:"NoUnderlyings", counter_id:"711"`
    Legs []TradeCaptureReportRequest_Legs.TradeCaptureReportRequest_Legs `counter_name:"NoLegs", counter_id:"555"`
    Dates []TradeCaptureReportRequest_Dates.TradeCaptureReportRequest_Dates `counter_name:"NoDates", counter_id:"580"`
