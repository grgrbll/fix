...
func (m *MarketDataSnapshotFullRefresh) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    (*res).WriteString("268=")
    (*res).WriteString(strconv.Itoa(len(m.MDEntries)))
    (*res).WriteString("\x01")
    for _, g := range m.MDEntries {
        err = g.MarshalFIX(res)
    }
    
    if m.ApplQueueDepth.HasValue() {
        (*res).WriteString("813=")
        val, err := m.ApplQueueDepth.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ApplQueueResolution.HasValue() {
        (*res).WriteString("814=")
        val, err := m.ApplQueueResolution.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.MDReportID.HasValue() {
        (*res).WriteString("963=")
        val, err := m.MDReportID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.MDBookType.HasValue() {
        (*res).WriteString("1021=")
        val, err := m.MDBookType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.MDFeedType.HasValue() {
        (*res).WriteString("1022=")
        val, err := m.MDFeedType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *MarketDataSnapshotFullRefresh) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message MarketDataSnapshotFullRefresh (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *MarketDataSnapshotFullRefresh) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 268:
            // This counter (NoMDEntries) indicates the start of repeated group block 
            count, _ := strconv.Atoi(value)
            m.MDEntries = make([]MDFullGrp_MDEntries, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
                m._controlBlock.mostRecentRepeatingGroup[i] = &m.MDEntries[i]
            }
            m._controlBlock.mostRecentRepeatingGroupCounter = 0
            used = true
        ...
        case 813:
            if !m.ApplQueueDepth.HasValue() {
                used = true
                err = m.ApplQueueDepth.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 814:
            if !m.ApplQueueResolution.HasValue() {
                used = true
                err = m.ApplQueueResolution.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 963:
            if !m.MDReportID.HasValue() {
                used = true
                err = m.MDReportID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1021:
            if !m.MDBookType.HasValue() {
                used = true
                err = m.MDBookType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1022:
            if !m.MDFeedType.HasValue() {
                used = true
                err = m.MDFeedType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
