...
type QuoteRequestReject struct {
    ...
    QuoteRequestRejectReason Types.Int `id:"658", required:"Y" `
    RelatedSym []QuotReqRjctGrp_RelatedSym.QuotReqRjctGrp_RelatedSym `counter_name:"NoRelatedSym", counter_id:"146"`
