...
func (m *NewOrderMultileg) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.MultiLegRptTypeReq.HasValue() {
        (*res).WriteString("563=")
        val, err := m.MultiLegRptTypeReq.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SwapPoints.HasValue() {
        (*res).WriteString("1069=")
        val, err := m.SwapPoints.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.RefOrderID.HasValue() {
        (*res).WriteString("1080=")
        val, err := m.RefOrderID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.RefOrderIDSource.HasValue() {
        (*res).WriteString("1081=")
        val, err := m.RefOrderIDSource.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *NewOrderMultileg) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message NewOrderMultileg (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *NewOrderMultileg) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 78:
            ...
            count, _ := strconv.Atoi(value)
            m.Allocs = make([]PreAllocMlegGrp_Allocs, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 555:
            ...
            count, _ := strconv.Atoi(value)
            m.Legs = make([]LegOrdGrp_Legs, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 563:
            if !m.MultiLegRptTypeReq.HasValue() {
                used = true
                err = m.MultiLegRptTypeReq.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1069:
            if !m.SwapPoints.HasValue() {
                used = true
                err = m.SwapPoints.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1080:
            if !m.RefOrderID.HasValue() {
                used = true
                err = m.RefOrderID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1081:
            if !m.RefOrderIDSource.HasValue() {
                used = true
                err = m.RefOrderIDSource.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
