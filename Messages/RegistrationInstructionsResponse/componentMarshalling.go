...
func (m *RegistrationInstructionsResponse) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.RegistRejReasonCode.HasValue() {
        (*res).WriteString("507=")
        val, err := m.RegistRejReasonCode.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.RegistRejReasonText.HasValue() {
        (*res).WriteString("496=")
        val, err := m.RegistRejReasonText.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *RegistrationInstructionsResponse) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message RegistrationInstructionsResponse (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *RegistrationInstructionsResponse) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 507:
            if !m.RegistRejReasonCode.HasValue() {
                used = true
                err = m.RegistRejReasonCode.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 496:
            if !m.RegistRejReasonText.HasValue() {
                used = true
                err = m.RegistRejReasonText.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
