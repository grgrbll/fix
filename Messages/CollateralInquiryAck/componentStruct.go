...
type CollateralInquiryAck struct {
    ...
    CollInquiryID Types.String `id:"909", required:"Y" `
    CollInquiryStatus Types.Int `id:"945", required:"Y" `
    CollInquiryResult Types.Int `id:"946", required:"N" `
    CollInquiryQualifier []CollInqQualGrp_CollInquiryQualifier.CollInqQualGrp_CollInquiryQualifier `counter_name:"NoCollInquiryQualifier", counter_id:"938"`
