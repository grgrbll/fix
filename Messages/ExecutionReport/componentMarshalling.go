...
func (m *ExecutionReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.OrdStatusReqID.HasValue() {
        (*res).WriteString("790=")
        val, err := m.OrdStatusReqID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TotNumReports.HasValue() {
        (*res).WriteString("911=")
        val, err := m.TotNumReports.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LastRptRequested.HasValue() {
        (*res).WriteString("912=")
        val, err := m.LastRptRequested.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if len(m.ContraBrokers) > 0 {
    
    (*res).WriteString("382=")
    (*res).WriteString(strconv.Itoa(len(m.ContraBrokers)))
    (*res).WriteString("\x01")
    ...
    if m.CrossID.HasValue() {
        (*res).WriteString("548=")
        val, err := m.CrossID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.OrigCrossID.HasValue() {
        (*res).WriteString("551=")
        val, err := m.OrigCrossID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CrossType.HasValue() {
        (*res).WriteString("549=")
        val, err := m.CrossType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PeggedPrice.HasValue() {
        (*res).WriteString("839=")
        val, err := m.PeggedPrice.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.DiscretionPrice.HasValue() {
        (*res).WriteString("845=")
        val, err := m.DiscretionPrice.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TargetStrategyPerformance.HasValue() {
        (*res).WriteString("850=")
        val, err := m.TargetStrategyPerformance.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.UnderlyingLastQty.HasValue() {
        (*res).WriteString("652=")
        val, err := m.UnderlyingLastQty.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.UnderlyingLastPx.HasValue() {
        (*res).WriteString("651=")
        val, err := m.UnderlyingLastPx.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.DayOrderQty.HasValue() {
        (*res).WriteString("424=")
        val, err := m.DayOrderQty.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.DayCumQty.HasValue() {
        (*res).WriteString("425=")
        val, err := m.DayCumQty.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.DayAvgPx.HasValue() {
        (*res).WriteString("426=")
        val, err := m.DayAvgPx.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ReportToExch.HasValue() {
        (*res).WriteString("113=")
        val, err := m.ReportToExch.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TradedFlatSwitch.HasValue() {
        (*res).WriteString("258=")
        val, err := m.TradedFlatSwitch.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.BasisFeatureDate.HasValue() {
        (*res).WriteString("259=")
        val, err := m.BasisFeatureDate.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.BasisFeaturePrice.HasValue() {
        (*res).WriteString("260=")
        val, err := m.BasisFeaturePrice.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LastForwardPoints2.HasValue() {
        (*res).WriteString("641=")
        val, err := m.LastForwardPoints2.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ExecValuationPoint.HasValue() {
        (*res).WriteString("515=")
        val, err := m.ExecValuationPoint.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ExecPriceType.HasValue() {
        (*res).WriteString("484=")
        val, err := m.ExecPriceType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ExecPriceAdjustment.HasValue() {
        (*res).WriteString("485=")
        val, err := m.ExecPriceAdjustment.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PriorityIndicator.HasValue() {
        (*res).WriteString("638=")
        val, err := m.PriorityIndicator.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PriceImprovement.HasValue() {
        (*res).WriteString("639=")
        val, err := m.PriceImprovement.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LastLiquidityInd.HasValue() {
        (*res).WriteString("851=")
        val, err := m.LastLiquidityInd.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.HostCrossID.HasValue() {
        (*res).WriteString("961=")
        val, err := m.HostCrossID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.OrderCategory.HasValue() {
        (*res).WriteString("1115=")
        val, err := m.OrderCategory.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PeggedRefPrice.HasValue() {
        (*res).WriteString("1095=")
        val, err := m.PeggedRefPrice.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *ExecutionReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message ExecutionReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *ExecutionReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 790:
            if !m.OrdStatusReqID.HasValue() {
                used = true
                err = m.OrdStatusReqID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 911:
            if !m.TotNumReports.HasValue() {
                used = true
                err = m.TotNumReports.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 912:
            if !m.LastRptRequested.HasValue() {
                used = true
                err = m.LastRptRequested.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 382:
            // This counter (NoContraBrokers) indicates the start of repeated group block 
            count, _ := strconv.Atoi(value)
            m.ContraBrokers = make([]ContraGrp_ContraBrokers, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
                m._controlBlock.mostRecentRepeatingGroup[i] = &m.ContraBrokers[i]
            }
            m._controlBlock.mostRecentRepeatingGroupCounter = 0
            used = true
        ...
        case 548:
            if !m.CrossID.HasValue() {
                used = true
                err = m.CrossID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 551:
            if !m.OrigCrossID.HasValue() {
                used = true
                err = m.OrigCrossID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 549:
            if !m.CrossType.HasValue() {
                used = true
                err = m.CrossType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 839:
            if !m.PeggedPrice.HasValue() {
                used = true
                err = m.PeggedPrice.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 845:
            if !m.DiscretionPrice.HasValue() {
                used = true
                err = m.DiscretionPrice.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 850:
            if !m.TargetStrategyPerformance.HasValue() {
                used = true
                err = m.TargetStrategyPerformance.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 652:
            if !m.UnderlyingLastQty.HasValue() {
                used = true
                err = m.UnderlyingLastQty.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 651:
            if !m.UnderlyingLastPx.HasValue() {
                used = true
                err = m.UnderlyingLastPx.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 424:
            if !m.DayOrderQty.HasValue() {
                used = true
                err = m.DayOrderQty.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 425:
            if !m.DayCumQty.HasValue() {
                used = true
                err = m.DayCumQty.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 426:
            if !m.DayAvgPx.HasValue() {
                used = true
                err = m.DayAvgPx.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 113:
            if !m.ReportToExch.HasValue() {
                used = true
                err = m.ReportToExch.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 258:
            if !m.TradedFlatSwitch.HasValue() {
                used = true
                err = m.TradedFlatSwitch.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 259:
            if !m.BasisFeatureDate.HasValue() {
                used = true
                err = m.BasisFeatureDate.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 260:
            if !m.BasisFeaturePrice.HasValue() {
                used = true
                err = m.BasisFeaturePrice.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 641:
            if !m.LastForwardPoints2.HasValue() {
                used = true
                err = m.LastForwardPoints2.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 515:
            if !m.ExecValuationPoint.HasValue() {
                used = true
                err = m.ExecValuationPoint.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 484:
            if !m.ExecPriceType.HasValue() {
                used = true
                err = m.ExecPriceType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 485:
            if !m.ExecPriceAdjustment.HasValue() {
                used = true
                err = m.ExecPriceAdjustment.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 638:
            if !m.PriorityIndicator.HasValue() {
                used = true
                err = m.PriorityIndicator.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 639:
            if !m.PriceImprovement.HasValue() {
                used = true
                err = m.PriceImprovement.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 851:
            if !m.LastLiquidityInd.HasValue() {
                used = true
                err = m.LastLiquidityInd.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 555:
            ...
            count, _ := strconv.Atoi(value)
            m.Legs = make([]InstrmtLegExecGrp_Legs, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 961:
            if !m.HostCrossID.HasValue() {
                used = true
                err = m.HostCrossID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1115:
            if !m.OrderCategory.HasValue() {
                used = true
                err = m.OrderCategory.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1095:
            if !m.PeggedRefPrice.HasValue() {
                used = true
                err = m.PeggedRefPrice.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
