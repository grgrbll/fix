...
func (m *UserRequest) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.UserRequestID.HasValue() {
        (*res).WriteString("923=")
        val, err := m.UserRequestID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.UserRequestType.HasValue() {
        (*res).WriteString("924=")
        val, err := m.UserRequestType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.NewPassword.HasValue() {
        (*res).WriteString("925=")
        val, err := m.NewPassword.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *UserRequest) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message UserRequest (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *UserRequest) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 923:
            if !m.UserRequestID.HasValue() {
                used = true
                err = m.UserRequestID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 924:
            if !m.UserRequestType.HasValue() {
                used = true
                err = m.UserRequestType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 925:
            if !m.NewPassword.HasValue() {
                used = true
                err = m.NewPassword.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
