...
type UserRequest struct {
    ...
    UserRequestID Types.String `id:"923", required:"Y" `
    UserRequestType Types.Int `id:"924", required:"Y" `
    Username Types.String `id:"553", required:"Y" `
    Password Types.String `id:"554", required:"N" `
    NewPassword Types.String `id:"925", required:"N" `
