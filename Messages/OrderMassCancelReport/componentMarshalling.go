...
func (m *OrderMassCancelReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.MassCancelRequestType.HasValue() {
        (*res).WriteString("530=")
        val, err := m.MassCancelRequestType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.MassCancelResponse.HasValue() {
        (*res).WriteString("531=")
        val, err := m.MassCancelResponse.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.MassCancelRejectReason.HasValue() {
        (*res).WriteString("532=")
        val, err := m.MassCancelRejectReason.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TotalAffectedOrders.HasValue() {
        (*res).WriteString("533=")
        val, err := m.TotalAffectedOrders.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if len(m.AffectedOrders) > 0 {
    
    (*res).WriteString("534=")
    (*res).WriteString(strconv.Itoa(len(m.AffectedOrders)))
    (*res).WriteString("\x01")
...
func (m *OrderMassCancelReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message OrderMassCancelReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *OrderMassCancelReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 530:
            if !m.MassCancelRequestType.HasValue() {
                used = true
                err = m.MassCancelRequestType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 531:
            if !m.MassCancelResponse.HasValue() {
                used = true
                err = m.MassCancelResponse.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 532:
            if !m.MassCancelRejectReason.HasValue() {
                used = true
                err = m.MassCancelRejectReason.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 533:
            if !m.TotalAffectedOrders.HasValue() {
                used = true
                err = m.TotalAffectedOrders.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 534:
            // This counter (NoAffectedOrders) indicates the start of repeated group block 
            count, _ := strconv.Atoi(value)
            m.AffectedOrders = make([]AffectedOrdGrp_AffectedOrders, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
                m._controlBlock.mostRecentRepeatingGroup[i] = &m.AffectedOrders[i]
            }
            m._controlBlock.mostRecentRepeatingGroupCounter = 0
            used = true
