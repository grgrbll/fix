...
func (m *ResendRequest) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.BeginSeqNo.HasValue() {
        (*res).WriteString("7=")
        val, err := m.BeginSeqNo.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.EndSeqNo.HasValue() {
        (*res).WriteString("16=")
        val, err := m.EndSeqNo.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *ResendRequest) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message ResendRequest (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *ResendRequest) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 7:
            if !m.BeginSeqNo.HasValue() {
                used = true
                err = m.BeginSeqNo.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 16:
            if !m.EndSeqNo.HasValue() {
                used = true
                err = m.EndSeqNo.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
