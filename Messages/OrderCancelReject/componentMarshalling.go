...
func (m *OrderCancelReject) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.CxlRejResponseTo.HasValue() {
        (*res).WriteString("434=")
        val, err := m.CxlRejResponseTo.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CxlRejReason.HasValue() {
        (*res).WriteString("102=")
        val, err := m.CxlRejReason.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *OrderCancelReject) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message OrderCancelReject (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *OrderCancelReject) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 434:
            if !m.CxlRejResponseTo.HasValue() {
                used = true
                err = m.CxlRejResponseTo.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 102:
            if !m.CxlRejReason.HasValue() {
                used = true
                err = m.CxlRejReason.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
