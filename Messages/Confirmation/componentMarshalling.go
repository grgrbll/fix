...
func (m *Confirmation) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.ConfirmID.HasValue() {
        (*res).WriteString("664=")
        val, err := m.ConfirmID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ConfirmRefID.HasValue() {
        (*res).WriteString("772=")
        val, err := m.ConfirmRefID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ConfirmReqID.HasValue() {
        (*res).WriteString("859=")
        val, err := m.ConfirmReqID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ConfirmTransType.HasValue() {
        (*res).WriteString("666=")
        val, err := m.ConfirmTransType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ConfirmType.HasValue() {
        (*res).WriteString("773=")
        val, err := m.ConfirmType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ConfirmStatus.HasValue() {
        (*res).WriteString("665=")
        val, err := m.ConfirmStatus.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    (*res).WriteString("862=")
    (*res).WriteString(strconv.Itoa(len(m.Capacities)))
    (*res).WriteString("\x01")
    ...
    if m.AllocAccountType.HasValue() {
        (*res).WriteString("798=")
        val, err := m.AllocAccountType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ReportedPx.HasValue() {
        (*res).WriteString("861=")
        val, err := m.ReportedPx.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.MaturityNetMoney.HasValue() {
        (*res).WriteString("890=")
        val, err := m.MaturityNetMoney.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SharedCommission.HasValue() {
        (*res).WriteString("858=")
        val, err := m.SharedCommission.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *Confirmation) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message Confirmation (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *Confirmation) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 664:
            if !m.ConfirmID.HasValue() {
                used = true
                err = m.ConfirmID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 772:
            if !m.ConfirmRefID.HasValue() {
                used = true
                err = m.ConfirmRefID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 859:
            if !m.ConfirmReqID.HasValue() {
                used = true
                err = m.ConfirmReqID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 666:
            if !m.ConfirmTransType.HasValue() {
                used = true
                err = m.ConfirmTransType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 773:
            if !m.ConfirmType.HasValue() {
                used = true
                err = m.ConfirmType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 665:
            if !m.ConfirmStatus.HasValue() {
                used = true
                err = m.ConfirmStatus.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 862:
            // This counter (NoCapacities) indicates the start of repeated group block 
            count, _ := strconv.Atoi(value)
            m.Capacities = make([]CpctyConfGrp_Capacities, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
                m._controlBlock.mostRecentRepeatingGroup[i] = &m.Capacities[i]
            }
            m._controlBlock.mostRecentRepeatingGroupCounter = 0
            used = true
        ...
        case 798:
            if !m.AllocAccountType.HasValue() {
                used = true
                err = m.AllocAccountType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 861:
            if !m.ReportedPx.HasValue() {
                used = true
                err = m.ReportedPx.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 890:
            if !m.MaturityNetMoney.HasValue() {
                used = true
                err = m.MaturityNetMoney.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 858:
            if !m.SharedCommission.HasValue() {
                used = true
                err = m.SharedCommission.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
