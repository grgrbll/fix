...
type ContraryIntentionReport struct {
    ...
    ContIntRptID Types.String `id:"977", required:"Y" `
    TransactTime Types.UTCTimestamp `id:"60", required:"N" `
    LateIndicator Types.Boolean `id:"978", required:"N" `
    InputSource Types.String `id:"979", required:"N" `
    ...
    Expiration []ExpirationQty_Expiration.ExpirationQty_Expiration `counter_name:"NoExpiration", counter_id:"981"`
