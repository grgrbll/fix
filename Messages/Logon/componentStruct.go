...
type Logon struct {
    ...
    EncryptMethod Types.Int `id:"98", required:"Y" `
    HeartBtInt Types.Int `id:"108", required:"Y" `
    RawDataLength Types.Length `id:"95", required:"N" `
    RawData Types.Data `id:"96", required:"N" `
    ResetSeqNumFlag Types.Boolean `id:"141", required:"N" `
    NextExpectedMsgSeqNum Types.SeqNum `id:"789", required:"N" `
    MaxMessageSize Types.Length `id:"383", required:"N" `
    TestMessageIndicator Types.Boolean `id:"464", required:"N" `
    Username Types.String `id:"553", required:"N" `
    Password Types.String `id:"554", required:"N" `
    DefaultApplVerID Types.String `id:"1137", required:"Y" `
    MsgTypes []MsgTypeGrp_MsgTypes.MsgTypeGrp_MsgTypes `counter_name:"NoMsgTypes", counter_id:"384"`
