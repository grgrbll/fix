...
func (m *CollateralInquiry) MarshalFIX(res *bufio.Writer) error {
    var err error
...
func (m *CollateralInquiry) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message CollateralInquiry (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *CollateralInquiry) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
