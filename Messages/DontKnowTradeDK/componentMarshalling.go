...
func (m *DontKnowTradeDK) MarshalFIX(res *bufio.Writer) error {
    var err error
...
func (m *DontKnowTradeDK) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message DontKnowTradeDK (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *DontKnowTradeDK) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
