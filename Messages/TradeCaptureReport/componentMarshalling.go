...
func (m *TradeCaptureReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.TradeRequestID.HasValue() {
        (*res).WriteString("568=")
        val, err := m.TradeRequestID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TotNumTradeReports.HasValue() {
        (*res).WriteString("748=")
        val, err := m.TotNumTradeReports.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TZTransactTime.HasValue() {
        (*res).WriteString("1132=")
        val, err := m.TZTransactTime.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ReportedPxDiff.HasValue() {
        (*res).WriteString("1134=")
        val, err := m.ReportedPxDiff.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *TradeCaptureReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message TradeCaptureReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *TradeCaptureReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 568:
            if !m.TradeRequestID.HasValue() {
                used = true
                err = m.TradeRequestID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 748:
            if !m.TotNumTradeReports.HasValue() {
                used = true
                err = m.TotNumTradeReports.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 552:
            ...
            count, _ := strconv.Atoi(value)
            m.Sides = make([]TrdCapRptSideGrp_Sides, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 1132:
            if !m.TZTransactTime.HasValue() {
                used = true
                err = m.TZTransactTime.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1134:
            if !m.ReportedPxDiff.HasValue() {
                used = true
                err = m.ReportedPxDiff.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
