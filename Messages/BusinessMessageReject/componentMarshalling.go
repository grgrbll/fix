...
func (m *BusinessMessageReject) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.RefSeqNum.HasValue() {
        (*res).WriteString("45=")
        val, err := m.RefSeqNum.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.BusinessRejectRefID.HasValue() {
        (*res).WriteString("379=")
        val, err := m.BusinessRejectRefID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.BusinessRejectReason.HasValue() {
        (*res).WriteString("380=")
        val, err := m.BusinessRejectReason.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *BusinessMessageReject) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message BusinessMessageReject (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *BusinessMessageReject) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 45:
            if !m.RefSeqNum.HasValue() {
                used = true
                err = m.RefSeqNum.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 379:
            if !m.BusinessRejectRefID.HasValue() {
                used = true
                err = m.BusinessRejectRefID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 380:
            if !m.BusinessRejectReason.HasValue() {
                used = true
                err = m.BusinessRejectReason.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
