...
type SettlementInstructions struct {
    ...
    SettlInstMsgID Types.String `id:"777", required:"Y" `
    SettlInstReqID Types.String `id:"791", required:"N" `
    SettlInstMode Types.Char `id:"160", required:"Y" `
    SettlInstReqRejCode Types.Int `id:"792", required:"N" `
    ...
    SettlInst []SettlInstGrp_SettlInst.SettlInstGrp_SettlInst `counter_name:"NoSettlInst", counter_id:"778"`
