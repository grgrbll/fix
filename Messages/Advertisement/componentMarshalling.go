...
func (m *Advertisement) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.AdvTransType.HasValue() {
        (*res).WriteString("5=")
        val, err := m.AdvTransType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.AdvRefID.HasValue() {
        (*res).WriteString("3=")
        val, err := m.AdvRefID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.AdvSide.HasValue() {
        (*res).WriteString("4=")
        val, err := m.AdvSide.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *Advertisement) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message Advertisement (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *Advertisement) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 2:
            if !m.AdvId.HasValue() {
                used = true
                err = m.AdvId.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 5:
            if !m.AdvTransType.HasValue() {
                used = true
                err = m.AdvTransType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 3:
            if !m.AdvRefID.HasValue() {
                used = true
                err = m.AdvRefID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 4:
            if !m.AdvSide.HasValue() {
                used = true
                err = m.AdvSide.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
