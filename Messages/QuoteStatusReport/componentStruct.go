...
type QuoteStatusReport struct {
    ...
    QuoteStatusReqID Types.String `id:"649", required:"N" `
    QuoteReqID Types.String `id:"131", required:"N" `
    QuoteID Types.String `id:"117", required:"Y" `
    ...
    Legs []LegQuotStatGrp_Legs.LegQuotStatGrp_Legs `counter_name:"NoLegs", counter_id:"555"`
    ...
    MktBidPx Types.Price `id:"645", required:"N" `
    MktOfferPx Types.Price `id:"646", required:"N" `
    MinBidSize Types.Qty `id:"647", required:"N" `
    BidSize Types.Qty `id:"134", required:"N" `
    MinOfferSize Types.Qty `id:"648", required:"N" `
    ...
    SettlCurrBidFxRate Types.Float `id:"656", required:"N" `
    SettlCurrOfferFxRate Types.Float `id:"657", required:"N" `
    ...
    QuoteStatus Types.Int `id:"297", required:"N" `
