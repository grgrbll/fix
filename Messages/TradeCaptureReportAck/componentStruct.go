...
type TradeCaptureReportAck struct {
    ...
    TradeReportRejectReason Types.Int `id:"751", required:"N" `
    ...
    Sides []TrdCapRptAckSideGrp_Sides.TrdCapRptAckSideGrp_Sides `counter_name:"NoSides", counter_id:"552"`
    ...
    RptSys Types.String `id:"1135", required:"N" `
