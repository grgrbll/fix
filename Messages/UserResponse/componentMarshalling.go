...
func (m *UserResponse) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.UserStatus.HasValue() {
        (*res).WriteString("926=")
        val, err := m.UserStatus.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.UserStatusText.HasValue() {
        (*res).WriteString("927=")
        val, err := m.UserStatusText.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *UserResponse) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message UserResponse (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *UserResponse) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 926:
            if !m.UserStatus.HasValue() {
                used = true
                err = m.UserStatus.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 927:
            if !m.UserStatusText.HasValue() {
                used = true
                err = m.UserStatusText.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
