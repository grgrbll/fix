...
type NetworkCounterpartySystemStatusRequest struct {
    ...
    NetworkRequestType Types.Int `id:"935", required:"Y" `
    NetworkRequestID Types.String `id:"933", required:"Y" `
    CompIDs []CompIDReqGrp_CompIDs.CompIDReqGrp_CompIDs `counter_name:"NoCompIDs", counter_id:"936"`
