...
func (m *AllocationReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.AllocReportID.HasValue() {
        (*res).WriteString("755=")
        val, err := m.AllocReportID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.AllocReportRefID.HasValue() {
        (*res).WriteString("795=")
        val, err := m.AllocReportRefID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.AllocReportType.HasValue() {
        (*res).WriteString("794=")
        val, err := m.AllocReportType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *AllocationReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message AllocationReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *AllocationReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 755:
            if !m.AllocReportID.HasValue() {
                used = true
                err = m.AllocReportID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 795:
            if !m.AllocReportRefID.HasValue() {
                used = true
                err = m.AllocReportRefID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 794:
            if !m.AllocReportType.HasValue() {
                used = true
                err = m.AllocReportType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
