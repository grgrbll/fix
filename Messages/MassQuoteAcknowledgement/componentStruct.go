...
type MassQuoteAcknowledgement struct {
    ...
    QuoteStatus Types.Int `id:"297", required:"Y" `
    QuoteRejectReason Types.Int `id:"300", required:"N" `
    ...
    QuoteSets []QuotSetAckGrp_QuoteSets.QuotSetAckGrp_QuoteSets `counter_name:"NoQuoteSets", counter_id:"296"`
