...
type PositionReport struct {
    ...
    PosReqType Types.Int `id:"724", required:"N" `
    SubscriptionRequestType Types.Char `id:"263", required:"N" `
    TotalNumPosReports Types.Int `id:"727", required:"N" `
    UnsolicitedIndicator Types.Boolean `id:"325", required:"N" `
    PosReqResult Types.Int `id:"728", required:"N" `
    ...
    SettlPrice Types.Price `id:"730", required:"N" `
    SettlPriceType Types.Int `id:"731", required:"N" `
    PriorSettlPrice Types.Price `id:"734", required:"N" `
    Legs []InstrmtLegGrp_Legs.InstrmtLegGrp_Legs `counter_name:"NoLegs", counter_id:"555"`
    Underlyings []PosUndInstrmtGrp_Underlyings.PosUndInstrmtGrp_Underlyings `counter_name:"NoUnderlyings", counter_id:"711"`
    ...
    RegistStatus Types.Char `id:"506", required:"N" `
    DeliveryDate Types.LocalMktDate `id:"743", required:"N" `
