...
func (m *PositionReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.PosReqType.HasValue() {
        (*res).WriteString("724=")
        val, err := m.PosReqType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TotalNumPosReports.HasValue() {
        (*res).WriteString("727=")
        val, err := m.TotalNumPosReports.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PosReqResult.HasValue() {
        (*res).WriteString("728=")
        val, err := m.PosReqResult.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.RegistStatus.HasValue() {
        (*res).WriteString("506=")
        val, err := m.RegistStatus.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.DeliveryDate.HasValue() {
        (*res).WriteString("743=")
        val, err := m.DeliveryDate.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *PositionReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message PositionReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *PositionReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 724:
            if !m.PosReqType.HasValue() {
                used = true
                err = m.PosReqType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 727:
            if !m.TotalNumPosReports.HasValue() {
                used = true
                err = m.TotalNumPosReports.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 728:
            if !m.PosReqResult.HasValue() {
                used = true
                err = m.PosReqResult.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 711:
            ...
            count, _ := strconv.Atoi(value)
            m.Underlyings = make([]PosUndInstrmtGrp_Underlyings, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 506:
            if !m.RegistStatus.HasValue() {
                used = true
                err = m.RegistStatus.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 743:
            if !m.DeliveryDate.HasValue() {
                used = true
                err = m.DeliveryDate.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
