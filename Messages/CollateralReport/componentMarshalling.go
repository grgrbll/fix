...
func (m *CollateralReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.CollRptID.HasValue() {
        (*res).WriteString("908=")
        val, err := m.CollRptID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollInquiryID.HasValue() {
        (*res).WriteString("909=")
        val, err := m.CollInquiryID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollStatus.HasValue() {
        (*res).WriteString("910=")
        val, err := m.CollStatus.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *CollateralReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message CollateralReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *CollateralReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 908:
            if !m.CollRptID.HasValue() {
                used = true
                err = m.CollRptID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 909:
            if !m.CollInquiryID.HasValue() {
                used = true
                err = m.CollInquiryID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 910:
            if !m.CollStatus.HasValue() {
                used = true
                err = m.CollStatus.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
