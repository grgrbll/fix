...
func (m *AssignmentReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.AsgnRptID.HasValue() {
        (*res).WriteString("833=")
        val, err := m.AsgnRptID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TotNumAssignmentReports.HasValue() {
        (*res).WriteString("832=")
        val, err := m.TotNumAssignmentReports.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SettlPrice.HasValue() {
        (*res).WriteString("730=")
        val, err := m.SettlPrice.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SettlPriceType.HasValue() {
        (*res).WriteString("731=")
        val, err := m.SettlPriceType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.UnderlyingSettlPrice.HasValue() {
        (*res).WriteString("732=")
        val, err := m.UnderlyingSettlPrice.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.AssignmentMethod.HasValue() {
        (*res).WriteString("744=")
        val, err := m.AssignmentMethod.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.AssignmentUnit.HasValue() {
        (*res).WriteString("745=")
        val, err := m.AssignmentUnit.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.OpenInterest.HasValue() {
        (*res).WriteString("746=")
        val, err := m.OpenInterest.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ExerciseMethod.HasValue() {
        (*res).WriteString("747=")
        val, err := m.ExerciseMethod.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PriorSettlPrice.HasValue() {
        (*res).WriteString("734=")
        val, err := m.PriorSettlPrice.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *AssignmentReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message AssignmentReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *AssignmentReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 833:
            if !m.AsgnRptID.HasValue() {
                used = true
                err = m.AsgnRptID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 832:
            if !m.TotNumAssignmentReports.HasValue() {
                used = true
                err = m.TotNumAssignmentReports.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 730:
            if !m.SettlPrice.HasValue() {
                used = true
                err = m.SettlPrice.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 731:
            if !m.SettlPriceType.HasValue() {
                used = true
                err = m.SettlPriceType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 732:
            if !m.UnderlyingSettlPrice.HasValue() {
                used = true
                err = m.UnderlyingSettlPrice.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 744:
            if !m.AssignmentMethod.HasValue() {
                used = true
                err = m.AssignmentMethod.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 745:
            if !m.AssignmentUnit.HasValue() {
                used = true
                err = m.AssignmentUnit.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 746:
            if !m.OpenInterest.HasValue() {
                used = true
                err = m.OpenInterest.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 747:
            if !m.ExerciseMethod.HasValue() {
                used = true
                err = m.ExerciseMethod.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 734:
            if !m.PriorSettlPrice.HasValue() {
                used = true
                err = m.PriorSettlPrice.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
