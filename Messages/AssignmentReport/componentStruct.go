...
type AssignmentReport struct {
    ...
    AsgnRptID Types.String `id:"833", required:"Y" `
    TotNumAssignmentReports Types.Int `id:"832", required:"N" `
    ...
    AssignmentMethod Types.Char `id:"744", required:"N" `
    AssignmentUnit Types.Qty `id:"745", required:"N" `
    OpenInterest Types.Amt `id:"746", required:"N" `
    ExerciseMethod Types.Char `id:"747", required:"N" `
