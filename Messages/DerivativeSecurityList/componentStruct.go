...
type DerivativeSecurityList struct {
    ...
    SecurityRequestResult Types.Int `id:"560", required:"Y" `
    ...
    RelatedSym []RelSymDerivSecGrp_RelatedSym.RelSymDerivSecGrp_RelatedSym `counter_name:"NoRelatedSym", counter_id:"146"`
