...
func (m *Reject) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.RefTagID.HasValue() {
        (*res).WriteString("371=")
        val, err := m.RefTagID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SessionRejectReason.HasValue() {
        (*res).WriteString("373=")
        val, err := m.SessionRejectReason.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *Reject) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message Reject (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *Reject) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 371:
            if !m.RefTagID.HasValue() {
                used = true
                err = m.RefTagID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 373:
            if !m.SessionRejectReason.HasValue() {
                used = true
                err = m.SessionRejectReason.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
