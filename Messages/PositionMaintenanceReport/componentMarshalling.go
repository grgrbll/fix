...
func (m *PositionMaintenanceReport) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.PosMaintRptID.HasValue() {
        (*res).WriteString("721=")
        val, err := m.PosMaintRptID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PosMaintStatus.HasValue() {
        (*res).WriteString("722=")
        val, err := m.PosMaintStatus.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PosMaintResult.HasValue() {
        (*res).WriteString("723=")
        val, err := m.PosMaintResult.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *PositionMaintenanceReport) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message PositionMaintenanceReport (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *PositionMaintenanceReport) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 721:
            if !m.PosMaintRptID.HasValue() {
                used = true
                err = m.PosMaintRptID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 722:
            if !m.PosMaintStatus.HasValue() {
                used = true
                err = m.PosMaintStatus.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 723:
            if !m.PosMaintResult.HasValue() {
                used = true
                err = m.PosMaintResult.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
