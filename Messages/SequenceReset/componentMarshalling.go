...
func (m *SequenceReset) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.GapFillFlag.HasValue() {
        (*res).WriteString("123=")
        val, err := m.GapFillFlag.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.NewSeqNo.HasValue() {
        (*res).WriteString("36=")
        val, err := m.NewSeqNo.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *SequenceReset) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message SequenceReset (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *SequenceReset) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 123:
            if !m.GapFillFlag.HasValue() {
                used = true
                err = m.GapFillFlag.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 36:
            if !m.NewSeqNo.HasValue() {
                used = true
                err = m.NewSeqNo.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
