...
func (m *TradeCaptureReportRequestAck) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.TradeRequestResult.HasValue() {
        (*res).WriteString("749=")
        val, err := m.TradeRequestResult.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TradeRequestStatus.HasValue() {
        (*res).WriteString("750=")
        val, err := m.TradeRequestStatus.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *TradeCaptureReportRequestAck) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message TradeCaptureReportRequestAck (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *TradeCaptureReportRequestAck) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 749:
            if !m.TradeRequestResult.HasValue() {
                used = true
                err = m.TradeRequestResult.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 750:
            if !m.TradeRequestStatus.HasValue() {
                used = true
                err = m.TradeRequestStatus.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
