...
type TradingSessionList struct {
    ...
    TradSesReqID Types.String `id:"335", required:"N" `
    TradingSessions []TrdSessLstGrp_TradingSessions.TrdSessLstGrp_TradingSessions `counter_name:"NoTradingSessions", counter_id:"386"`
