...
type CollateralResponse struct {
    ...
    CollRespID Types.String `id:"904", required:"Y" `
    CollAsgnID Types.String `id:"902", required:"N" `
    CollReqID Types.String `id:"894", required:"N" `
    CollAsgnReason Types.Int `id:"895", required:"N" `
    CollAsgnTransType Types.Int `id:"903", required:"N" `
    CollAsgnRespType Types.Int `id:"905", required:"Y" `
    CollAsgnRejectReason Types.Int `id:"906", required:"N" `
    ...
    CollApplType Types.Int `id:"1043", required:"N" `
