...
func (m *CollateralResponse) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.CollRespID.HasValue() {
        (*res).WriteString("904=")
        val, err := m.CollRespID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollAsgnID.HasValue() {
        (*res).WriteString("902=")
        val, err := m.CollAsgnID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollReqID.HasValue() {
        (*res).WriteString("894=")
        val, err := m.CollReqID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollAsgnReason.HasValue() {
        (*res).WriteString("895=")
        val, err := m.CollAsgnReason.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollAsgnTransType.HasValue() {
        (*res).WriteString("903=")
        val, err := m.CollAsgnTransType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollAsgnRespType.HasValue() {
        (*res).WriteString("905=")
        val, err := m.CollAsgnRespType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollAsgnRejectReason.HasValue() {
        (*res).WriteString("906=")
        val, err := m.CollAsgnRejectReason.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    (*res).WriteString("897=")
    (*res).WriteString(strconv.Itoa(len(m.Trades)))
    (*res).WriteString("\x01")
    ...
    if m.MarginExcess.HasValue() {
        (*res).WriteString("899=")
        val, err := m.MarginExcess.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.TotalNetValue.HasValue() {
        (*res).WriteString("900=")
        val, err := m.TotalNetValue.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CashOutstanding.HasValue() {
        (*res).WriteString("901=")
        val, err := m.CashOutstanding.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.CollApplType.HasValue() {
        (*res).WriteString("1043=")
        val, err := m.CollApplType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *CollateralResponse) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message CollateralResponse (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *CollateralResponse) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 904:
            if !m.CollRespID.HasValue() {
                used = true
                err = m.CollRespID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 902:
            if !m.CollAsgnID.HasValue() {
                used = true
                err = m.CollAsgnID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 894:
            if !m.CollReqID.HasValue() {
                used = true
                err = m.CollReqID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 895:
            if !m.CollAsgnReason.HasValue() {
                used = true
                err = m.CollAsgnReason.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 903:
            if !m.CollAsgnTransType.HasValue() {
                used = true
                err = m.CollAsgnTransType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 905:
            if !m.CollAsgnRespType.HasValue() {
                used = true
                err = m.CollAsgnRespType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 906:
            if !m.CollAsgnRejectReason.HasValue() {
                used = true
                err = m.CollAsgnRejectReason.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 124:
            ...
            count, _ := strconv.Atoi(value)
            m.Execs = make([]ExecCollGrp_Execs, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 897:
            // This counter (NoTrades) indicates the start of repeated group block 
            count, _ := strconv.Atoi(value)
            m.Trades = make([]TrdCollGrp_Trades, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
                m._controlBlock.mostRecentRepeatingGroup[i] = &m.Trades[i]
            }
            m._controlBlock.mostRecentRepeatingGroupCounter = 0
            used = true
        ...
        case 711:
            ...
            count, _ := strconv.Atoi(value)
            m.Underlyings = make([]UndInstrmtCollGrp_Underlyings, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 899:
            if !m.MarginExcess.HasValue() {
                used = true
                err = m.MarginExcess.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 900:
            if !m.TotalNetValue.HasValue() {
                used = true
                err = m.TotalNetValue.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 901:
            if !m.CashOutstanding.HasValue() {
                used = true
                err = m.CashOutstanding.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1043:
            if !m.CollApplType.HasValue() {
                used = true
                err = m.CollApplType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
