...
func (m *Email) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.EmailThreadID.HasValue() {
        (*res).WriteString("164=")
        val, err := m.EmailThreadID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.EmailType.HasValue() {
        (*res).WriteString("94=")
        val, err := m.EmailType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.Subject.HasValue() {
        (*res).WriteString("147=")
        val, err := m.Subject.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.EncodedSubjectLen.HasValue() {
        (*res).WriteString("356=")
        val, err := m.EncodedSubjectLen.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.EncodedSubject.HasValue() {
        (*res).WriteString("357=")
        val, err := m.EncodedSubject.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *Email) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message Email (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *Email) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 164:
            if !m.EmailThreadID.HasValue() {
                used = true
                err = m.EmailThreadID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 94:
            if !m.EmailType.HasValue() {
                used = true
                err = m.EmailType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 147:
            if !m.Subject.HasValue() {
                used = true
                err = m.Subject.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 356:
            if !m.EncodedSubjectLen.HasValue() {
                used = true
                err = m.EncodedSubjectLen.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 357:
            if !m.EncodedSubject.HasValue() {
                used = true
                err = m.EncodedSubject.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
