...
func (m *ConfirmationAck) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.AffirmStatus.HasValue() {
        (*res).WriteString("940=")
        val, err := m.AffirmStatus.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ConfirmRejReason.HasValue() {
        (*res).WriteString("774=")
        val, err := m.ConfirmRejReason.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *ConfirmationAck) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message ConfirmationAck (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *ConfirmationAck) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 940:
            if !m.AffirmStatus.HasValue() {
                used = true
                err = m.AffirmStatus.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 774:
            if !m.ConfirmRejReason.HasValue() {
                used = true
                err = m.ConfirmRejReason.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
