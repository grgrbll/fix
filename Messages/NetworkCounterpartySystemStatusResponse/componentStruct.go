...
type NetworkCounterpartySystemStatusResponse struct {
    ...
    NetworkStatusResponseType Types.Int `id:"937", required:"Y" `
    NetworkRequestID Types.String `id:"933", required:"N" `
    NetworkResponseID Types.String `id:"932", required:"Y" `
    LastNetworkResponseID Types.String `id:"934", required:"N" `
    CompIDs []CompIDStatGrp_CompIDs.CompIDStatGrp_CompIDs `counter_name:"NoCompIDs", counter_id:"936"`
