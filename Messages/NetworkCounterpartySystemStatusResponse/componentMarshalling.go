...
func (m *NetworkCounterpartySystemStatusResponse) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.NetworkStatusResponseType.HasValue() {
        (*res).WriteString("937=")
        val, err := m.NetworkStatusResponseType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.NetworkRequestID.HasValue() {
        (*res).WriteString("933=")
        val, err := m.NetworkRequestID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.NetworkResponseID.HasValue() {
        (*res).WriteString("932=")
        val, err := m.NetworkResponseID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LastNetworkResponseID.HasValue() {
        (*res).WriteString("934=")
        val, err := m.LastNetworkResponseID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    (*res).WriteString("936=")
    (*res).WriteString(strconv.Itoa(len(m.CompIDs)))
    (*res).WriteString("\x01")
...
func (m *NetworkCounterpartySystemStatusResponse) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message NetworkCounterpartySystemStatusResponse (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *NetworkCounterpartySystemStatusResponse) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 937:
            if !m.NetworkStatusResponseType.HasValue() {
                used = true
                err = m.NetworkStatusResponseType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 933:
            if !m.NetworkRequestID.HasValue() {
                used = true
                err = m.NetworkRequestID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 932:
            if !m.NetworkResponseID.HasValue() {
                used = true
                err = m.NetworkResponseID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 934:
            if !m.LastNetworkResponseID.HasValue() {
                used = true
                err = m.LastNetworkResponseID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 936:
            // This counter (NoCompIDs) indicates the start of repeated group block 
            count, _ := strconv.Atoi(value)
            m.CompIDs = make([]CompIDStatGrp_CompIDs, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
                m._controlBlock.mostRecentRepeatingGroup[i] = &m.CompIDs[i]
            }
            m._controlBlock.mostRecentRepeatingGroupCounter = 0
            used = true
