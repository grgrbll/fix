...
type IOI struct {
    ...
    IOIID Types.String `id:"23", required:"Y" `
    IOITransType Types.Char `id:"28", required:"Y" `
    IOIRefID Types.String `id:"26", required:"N" `
    ...
    IOIQty Types.String `id:"27", required:"Y" `
    ...
    Legs []InstrmtLegIOIGrp_Legs.InstrmtLegIOIGrp_Legs `counter_name:"NoLegs", counter_id:"555"`
    ...
    IOIQltyInd Types.Char `id:"25", required:"N" `
    IOINaturalFlag Types.Boolean `id:"130", required:"N" `
    IOIQualifiers []IOIQualGrp_IOIQualifiers.IOIQualGrp_IOIQualifiers `counter_name:"NoIOIQualifiers", counter_id:"199"`
