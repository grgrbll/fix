...
func (m *IOI) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.IOITransType.HasValue() {
        (*res).WriteString("28=")
        val, err := m.IOITransType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.IOIRefID.HasValue() {
        (*res).WriteString("26=")
        val, err := m.IOIRefID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.IOIQty.HasValue() {
        (*res).WriteString("27=")
        val, err := m.IOIQty.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.IOIQltyInd.HasValue() {
        (*res).WriteString("25=")
        val, err := m.IOIQltyInd.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.IOINaturalFlag.HasValue() {
        (*res).WriteString("130=")
        val, err := m.IOINaturalFlag.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if len(m.IOIQualifiers) > 0 {
    
    (*res).WriteString("199=")
    (*res).WriteString(strconv.Itoa(len(m.IOIQualifiers)))
    (*res).WriteString("\x01")
...
func (m *IOI) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message IOI (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *IOI) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 28:
            if !m.IOITransType.HasValue() {
                used = true
                err = m.IOITransType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 26:
            if !m.IOIRefID.HasValue() {
                used = true
                err = m.IOIRefID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 27:
            if !m.IOIQty.HasValue() {
                used = true
                err = m.IOIQty.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 555:
            ...
            count, _ := strconv.Atoi(value)
            m.Legs = make([]InstrmtLegIOIGrp_Legs, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 25:
            if !m.IOIQltyInd.HasValue() {
                used = true
                err = m.IOIQltyInd.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 130:
            if !m.IOINaturalFlag.HasValue() {
                used = true
                err = m.IOINaturalFlag.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 199:
            // This counter (NoIOIQualifiers) indicates the start of repeated group block 
            count, _ := strconv.Atoi(value)
            m.IOIQualifiers = make([]IOIQualGrp_IOIQualifiers, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
                m._controlBlock.mostRecentRepeatingGroup[i] = &m.IOIQualifiers[i]
            }
            m._controlBlock.mostRecentRepeatingGroupCounter = 0
            used = true
