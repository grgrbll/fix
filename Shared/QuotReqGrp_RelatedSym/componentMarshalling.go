...
func (m *QuotReqGrp_RelatedSym) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.PrevClosePx.HasValue() {
        (*res).WriteString("140=")
        val, err := m.PrevClosePx.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.QuoteRequestType.HasValue() {
        (*res).WriteString("303=")
        val, err := m.QuoteRequestType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.QuotePriceType.HasValue() {
        (*res).WriteString("692=")
        val, err := m.QuotePriceType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *QuotReqGrp_RelatedSym) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message QuotReqGrp_RelatedSym (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *QuotReqGrp_RelatedSym) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 140:
            if !m.PrevClosePx.HasValue() {
                used = true
                err = m.PrevClosePx.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 303:
            if !m.QuoteRequestType.HasValue() {
                used = true
                err = m.QuoteRequestType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 555:
            ...
            count, _ := strconv.Atoi(value)
            m.Legs = make([]QuotReqLegsGrp_Legs, count)
            m._controlBlock.mostRecentRepeatingGroup = make([]FixMessage, count)
            for i := 0; i < count; i++ {
        ...
        case 692:
            if !m.QuotePriceType.HasValue() {
                used = true
                err = m.QuotePriceType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
