...
func (m *LegStipulations_LegStipulations) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.LegStipulationType.HasValue() {
        (*res).WriteString("688=")
        val, err := m.LegStipulationType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegStipulationValue.HasValue() {
        (*res).WriteString("689=")
        val, err := m.LegStipulationValue.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *LegStipulations_LegStipulations) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message LegStipulations_LegStipulations (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *LegStipulations_LegStipulations) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 688:
            if !m.LegStipulationType.HasValue() {
                used = true
                err = m.LegStipulationType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 689:
            if !m.LegStipulationValue.HasValue() {
                used = true
                err = m.LegStipulationValue.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
