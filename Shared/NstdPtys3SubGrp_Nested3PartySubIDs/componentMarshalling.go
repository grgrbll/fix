...
func (m *NstdPtys3SubGrp_Nested3PartySubIDs) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.Nested3PartySubID.HasValue() {
        (*res).WriteString("953=")
        val, err := m.Nested3PartySubID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.Nested3PartySubIDType.HasValue() {
        (*res).WriteString("954=")
        val, err := m.Nested3PartySubIDType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *NstdPtys3SubGrp_Nested3PartySubIDs) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message NstdPtys3SubGrp_Nested3PartySubIDs (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *NstdPtys3SubGrp_Nested3PartySubIDs) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 953:
            if !m.Nested3PartySubID.HasValue() {
                used = true
                err = m.Nested3PartySubID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 954:
            if !m.Nested3PartySubIDType.HasValue() {
                used = true
                err = m.Nested3PartySubIDType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
