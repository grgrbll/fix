...
func (m *StrategyParametersGrp_StrategyParameters) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.StrategyParameterName.HasValue() {
        (*res).WriteString("958=")
        val, err := m.StrategyParameterName.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.StrategyParameterType.HasValue() {
        (*res).WriteString("959=")
        val, err := m.StrategyParameterType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.StrategyParameterValue.HasValue() {
        (*res).WriteString("960=")
        val, err := m.StrategyParameterValue.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *StrategyParametersGrp_StrategyParameters) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message StrategyParametersGrp_StrategyParameters (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *StrategyParametersGrp_StrategyParameters) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 958:
            if !m.StrategyParameterName.HasValue() {
                used = true
                err = m.StrategyParameterName.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 959:
            if !m.StrategyParameterType.HasValue() {
                used = true
                err = m.StrategyParameterType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 960:
            if !m.StrategyParameterValue.HasValue() {
                used = true
                err = m.StrategyParameterValue.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
