...
func (m *ContAmtGrp_ContAmts) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.ContAmtType.HasValue() {
        (*res).WriteString("519=")
        val, err := m.ContAmtType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ContAmtValue.HasValue() {
        (*res).WriteString("520=")
        val, err := m.ContAmtValue.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.ContAmtCurr.HasValue() {
        (*res).WriteString("521=")
        val, err := m.ContAmtCurr.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *ContAmtGrp_ContAmts) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message ContAmtGrp_ContAmts (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *ContAmtGrp_ContAmts) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 519:
            if !m.ContAmtType.HasValue() {
                used = true
                err = m.ContAmtType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 520:
            if !m.ContAmtValue.HasValue() {
                used = true
                err = m.ContAmtValue.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 521:
            if !m.ContAmtCurr.HasValue() {
                used = true
                err = m.ContAmtCurr.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
