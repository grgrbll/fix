...
func (m *PositionAmountData_PosAmt) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.PosAmtType.HasValue() {
        (*res).WriteString("707=")
        val, err := m.PosAmtType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PosAmt.HasValue() {
        (*res).WriteString("708=")
        val, err := m.PosAmt.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.PositionCurrency.HasValue() {
        (*res).WriteString("1055=")
        val, err := m.PositionCurrency.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *PositionAmountData_PosAmt) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message PositionAmountData_PosAmt (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *PositionAmountData_PosAmt) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 707:
            if !m.PosAmtType.HasValue() {
                used = true
                err = m.PosAmtType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 708:
            if !m.PosAmt.HasValue() {
                used = true
                err = m.PosAmt.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1055:
            if !m.PositionCurrency.HasValue() {
                used = true
                err = m.PositionCurrency.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
