...
func (m *UndlyInstrumentPtysSubGrp_UndlyInstrumentPartySubIDs) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.UndlyInstrumentPartySubID.HasValue() {
        (*res).WriteString("1063=")
        val, err := m.UndlyInstrumentPartySubID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.UndlyInstrumentPartySubIDType.HasValue() {
        (*res).WriteString("1064=")
        val, err := m.UndlyInstrumentPartySubIDType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *UndlyInstrumentPtysSubGrp_UndlyInstrumentPartySubIDs) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message UndlyInstrumentPtysSubGrp_UndlyInstrumentPartySubIDs (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *UndlyInstrumentPtysSubGrp_UndlyInstrumentPartySubIDs) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 1063:
            if !m.UndlyInstrumentPartySubID.HasValue() {
                used = true
                err = m.UndlyInstrumentPartySubID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1064:
            if !m.UndlyInstrumentPartySubIDType.HasValue() {
                used = true
                err = m.UndlyInstrumentPartySubIDType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
