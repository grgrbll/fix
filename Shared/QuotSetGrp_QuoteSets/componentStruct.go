...
type QuotSetGrp_QuoteSets struct {
    QuoteSetID Types.String `id:"302", required:"Y" `
    ...
    QuoteSetValidUntilTime Types.UTCTimestamp `id:"367", required:"N" `
    TotNoQuoteEntries Types.Int `id:"304", required:"Y" `
    LastFragment Types.Boolean `id:"893", required:"N" `
    QuoteEntries []QuotEntryGrp_QuoteEntries.QuotEntryGrp_QuoteEntries `counter_name:"NoQuoteEntries", counter_id:"295"`
