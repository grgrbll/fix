...
type QuotSetAckGrp_QuoteSets struct {
    QuoteSetID Types.String `id:"302", required:"N" `
    ...
    TotNoQuoteEntries Types.Int `id:"304", required:"N" `
    LastFragment Types.Boolean `id:"893", required:"N" `
    QuoteEntries []QuotEntryAckGrp_QuoteEntries.QuotEntryAckGrp_QuoteEntries `counter_name:"NoQuoteEntries", counter_id:"295"`
