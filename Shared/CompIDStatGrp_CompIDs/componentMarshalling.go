...
func (m *CompIDStatGrp_CompIDs) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.StatusValue.HasValue() {
        (*res).WriteString("928=")
        val, err := m.StatusValue.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.StatusText.HasValue() {
        (*res).WriteString("929=")
        val, err := m.StatusText.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *CompIDStatGrp_CompIDs) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message CompIDStatGrp_CompIDs (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *CompIDStatGrp_CompIDs) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 928:
            if !m.StatusValue.HasValue() {
                used = true
                err = m.StatusValue.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 929:
            if !m.StatusText.HasValue() {
                used = true
                err = m.StatusText.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
