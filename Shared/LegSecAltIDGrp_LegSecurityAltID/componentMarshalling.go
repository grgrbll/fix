...
func (m *LegSecAltIDGrp_LegSecurityAltID) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.LegSecurityAltID.HasValue() {
        (*res).WriteString("605=")
        val, err := m.LegSecurityAltID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegSecurityAltIDSource.HasValue() {
        (*res).WriteString("606=")
        val, err := m.LegSecurityAltIDSource.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *LegSecAltIDGrp_LegSecurityAltID) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message LegSecAltIDGrp_LegSecurityAltID (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *LegSecAltIDGrp_LegSecurityAltID) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 605:
            if !m.LegSecurityAltID.HasValue() {
                used = true
                err = m.LegSecurityAltID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 606:
            if !m.LegSecurityAltIDSource.HasValue() {
                used = true
                err = m.LegSecurityAltIDSource.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
