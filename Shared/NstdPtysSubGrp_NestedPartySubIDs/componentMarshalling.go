...
func (m *NstdPtysSubGrp_NestedPartySubIDs) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.NestedPartySubID.HasValue() {
        (*res).WriteString("545=")
        val, err := m.NestedPartySubID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.NestedPartySubIDType.HasValue() {
        (*res).WriteString("805=")
        val, err := m.NestedPartySubIDType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *NstdPtysSubGrp_NestedPartySubIDs) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message NstdPtysSubGrp_NestedPartySubIDs (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *NstdPtysSubGrp_NestedPartySubIDs) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 545:
            if !m.NestedPartySubID.HasValue() {
                used = true
                err = m.NestedPartySubID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 805:
            if !m.NestedPartySubIDType.HasValue() {
                used = true
                err = m.NestedPartySubIDType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
