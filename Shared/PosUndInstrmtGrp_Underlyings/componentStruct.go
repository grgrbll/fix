...
type PosUndInstrmtGrp_Underlyings struct {
    ...
    UnderlyingSettlPrice Types.Price `id:"732", required:"N" `
    UnderlyingSettlPriceType Types.Int `id:"733", required:"N" `
    UnderlyingAmounts []UnderlyingAmount_UnderlyingAmounts.UnderlyingAmount_UnderlyingAmounts `counter_name:"NoUnderlyingAmounts", counter_id:"984"`
    UnderlyingDeliveryAmount Types.Amt `id:"1037", required:"N" `
