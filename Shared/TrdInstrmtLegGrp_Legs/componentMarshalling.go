...
func (m *TrdInstrmtLegGrp_Legs) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.LegPositionEffect.HasValue() {
        (*res).WriteString("564=")
        val, err := m.LegPositionEffect.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegCoveredOrUncovered.HasValue() {
        (*res).WriteString("565=")
        val, err := m.LegCoveredOrUncovered.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegLastPx.HasValue() {
        (*res).WriteString("637=")
        val, err := m.LegLastPx.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegReportID.HasValue() {
        (*res).WriteString("990=")
        val, err := m.LegReportID.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegLastForwardPoints.HasValue() {
        (*res).WriteString("1073=")
        val, err := m.LegLastForwardPoints.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegCalculatedCcyLastQty.HasValue() {
        (*res).WriteString("1074=")
        val, err := m.LegCalculatedCcyLastQty.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegGrossTradeAmt.HasValue() {
        (*res).WriteString("1075=")
        val, err := m.LegGrossTradeAmt.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *TrdInstrmtLegGrp_Legs) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message TrdInstrmtLegGrp_Legs (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *TrdInstrmtLegGrp_Legs) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 564:
            if !m.LegPositionEffect.HasValue() {
                used = true
                err = m.LegPositionEffect.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 565:
            if !m.LegCoveredOrUncovered.HasValue() {
                used = true
                err = m.LegCoveredOrUncovered.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 637:
            if !m.LegLastPx.HasValue() {
                used = true
                err = m.LegLastPx.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 990:
            if !m.LegReportID.HasValue() {
                used = true
                err = m.LegReportID.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1073:
            if !m.LegLastForwardPoints.HasValue() {
                used = true
                err = m.LegLastForwardPoints.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1074:
            if !m.LegCalculatedCcyLastQty.HasValue() {
                used = true
                err = m.LegCalculatedCcyLastQty.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1075:
            if !m.LegGrossTradeAmt.HasValue() {
                used = true
                err = m.LegGrossTradeAmt.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
