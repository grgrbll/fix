...
func (m *SideTrdRegTS_SideTrdRegTS) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.SideTrdRegTimestamp.HasValue() {
        (*res).WriteString("1012=")
        val, err := m.SideTrdRegTimestamp.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SideTrdRegTimestampType.HasValue() {
        (*res).WriteString("1013=")
        val, err := m.SideTrdRegTimestampType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.SideTrdRegTimestampSrc.HasValue() {
        (*res).WriteString("1014=")
        val, err := m.SideTrdRegTimestampSrc.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *SideTrdRegTS_SideTrdRegTS) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message SideTrdRegTS_SideTrdRegTS (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *SideTrdRegTS_SideTrdRegTS) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 1012:
            if !m.SideTrdRegTimestamp.HasValue() {
                used = true
                err = m.SideTrdRegTimestamp.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1013:
            if !m.SideTrdRegTimestampType.HasValue() {
                used = true
                err = m.SideTrdRegTimestampType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1014:
            if !m.SideTrdRegTimestampSrc.HasValue() {
                used = true
                err = m.SideTrdRegTimestampSrc.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
