...
func (m *LegQuotGrp_Legs) MarshalFIX(res *bufio.Writer) error {
    var err error
    ...
    if m.LegPriceType.HasValue() {
        (*res).WriteString("686=")
        val, err := m.LegPriceType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegBidPx.HasValue() {
        (*res).WriteString("681=")
        val, err := m.LegBidPx.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegOfferPx.HasValue() {
        (*res).WriteString("684=")
        val, err := m.LegOfferPx.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegBidForwardPoints.HasValue() {
        (*res).WriteString("1067=")
        val, err := m.LegBidForwardPoints.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.LegOfferForwardPoints.HasValue() {
        (*res).WriteString("1068=")
        val, err := m.LegOfferForwardPoints.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *LegQuotGrp_Legs) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message LegQuotGrp_Legs (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *LegQuotGrp_Legs) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 686:
            if !m.LegPriceType.HasValue() {
                used = true
                err = m.LegPriceType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 681:
            if !m.LegBidPx.HasValue() {
                used = true
                err = m.LegBidPx.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 684:
            if !m.LegOfferPx.HasValue() {
                used = true
                err = m.LegOfferPx.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1067:
            if !m.LegBidForwardPoints.HasValue() {
                used = true
                err = m.LegBidForwardPoints.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 1068:
            if !m.LegOfferForwardPoints.HasValue() {
                used = true
                err = m.LegOfferForwardPoints.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
