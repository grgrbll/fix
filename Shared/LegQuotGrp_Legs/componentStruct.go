...
type LegQuotGrp_Legs struct {
    ...
    LegPriceType Types.Int `id:"686", required:"N" `
    LegBidPx Types.Price `id:"681", required:"N" `
    LegOfferPx Types.Price `id:"684", required:"N" `
    ...
    LegBidForwardPoints Types.PriceOffset `id:"1067", required:"N" `
    LegOfferForwardPoints Types.PriceOffset `id:"1068", required:"N" `
