...
func (m *Stipulations_Stipulations) MarshalFIX(res *bufio.Writer) error {
    var err error
    
    if m.StipulationType.HasValue() {
        (*res).WriteString("233=")
        val, err := m.StipulationType.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
    ...
    if m.StipulationValue.HasValue() {
        (*res).WriteString("234=")
        val, err := m.StipulationValue.MarshalFIX()
        if err != nil {
            return err
        }
        (*res).Write(val)
...
func (m *Stipulations_Stipulations) UnmarshalFIX(input io.Reader) error {
    var err error
    var field []byte
    for field, err = input.ReadSlice([]byte("\x01")); err == nil {
        ...
        if len(slices) != 2 {
            ...
            if !used {
                err = errors.New(fmt.Sprintf("Field unused by message Stipulations_Stipulations (%s)", string(field)))
            }
        }
        if err != nil {
            break
...
func (m *Stipulations_Stipulations) UnmarshalFieldFIX(id int, value []byte) (bool, error) {
    ...
    if !used {
        ...
        case 233:
            if !m.StipulationType.HasValue() {
                used = true
                err = m.StipulationType.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
        ...
        case 234:
            if !m.StipulationValue.HasValue() {
                used = true
                err = m.StipulationValue.UnmarshalFIX(value)
                if err != nil {
                    return used, err
                }
            }
